...
void fluxCalculation_1stOrder_Hou(at::Tensor wetMask, at::Tensor h_flux,
                                  at::Tensor qx_flux, at::Tensor qy_flux,
                                  at::Tensor h, at::Tensor wl, at::Tensor z,
                                  at::Tensor qx, at::Tensor qy,
                                  at::Tensor index, at::Tensor normal,
                                  at::Tensor given_depth, at::Tensor given_q,
                                  at::Tensor dx, at::Tensor t, at::Tensor dt) {
  CHECK_INPUT(h);
  CHECK_INPUT(wetMask);
  CHECK_INPUT(wl);
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  m.def("addFlux", &fluxCalculation_1stOrder_Hou,
        "Flux Reconstructed Bed Calculation (CUDA)");
}

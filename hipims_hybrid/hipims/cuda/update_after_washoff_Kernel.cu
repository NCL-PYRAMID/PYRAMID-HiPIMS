...
__global__ void update_after_washoff_kernel(const int N, const int PNN_assigned, 
                                                int32_t *__restrict__ pid_assigned, 
                                                int32_t *__restrict__ layer, int32_t *__restrict__ cellid, 
...
void update_after_washoff_cuda(at::Tensor pid_assigned, at::Tensor layer, at::Tensor cellid,
    ...
    update_after_washoff_kernel<int32_t><<<block_0, thread_0, 0, stream>>>(
        N, PNN_assigned, pid_assigned.data<int32_t>(), layer.data<int32_t>(), 

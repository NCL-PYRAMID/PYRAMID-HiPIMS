...
void fluxCalculation_2ndOrder_chen(at::Tensor wetMask, at::Tensor h_flux,
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  m.def("addFlux", &fluxCalculation_2ndOrder_chen, "Flux Reconstructed Bed Calculation (CUDA)");
}

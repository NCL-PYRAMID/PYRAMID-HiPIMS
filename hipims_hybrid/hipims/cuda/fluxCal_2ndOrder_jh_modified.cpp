...
void fluxCalculation_2ndOrder_jh_modified(at::Tensor wetMask, at::Tensor h_flux,
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  m.def("addFlux", &fluxCalculation_2ndOrder_jh_modified, "Flux Reconstructed Bed Calculation (CUDA)");
}

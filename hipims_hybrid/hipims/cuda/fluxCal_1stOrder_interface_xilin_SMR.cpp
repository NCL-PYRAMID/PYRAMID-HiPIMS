...
void fluxCalculation_1stOrder_xilin_SMR(at::Tensor wetMask, at::Tensor h_flux,
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  m.def("addFlux", &fluxCalculation_1stOrder_xilin_SMR, "Flux Reconstructed Bed Calculation (CUDA)");
}

...
def run(paraDict):
    ...
    # set Ms_num, Mg_num
    # ===============================================
    tol_classes = paraDict['tol_classes']
    Ms_num = torch.zeros(size=(tol_classes,tensorsize),dtype=torch.int32, device=device)
    Mg_num = torch.zeros(size=(tol_classes,tensorsize),dtype=torch.int32, device=device)
    Ms_cum = torch.zeros(size=(tol_classes,tensorsize),dtype=torch.int32, device=device)
    Mg_cum = torch.zeros(size=(tol_classes,tensorsize),dtype=torch.int32, device=device)

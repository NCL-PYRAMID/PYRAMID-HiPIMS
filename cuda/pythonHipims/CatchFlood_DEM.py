...
def run(paraDict):
    ...
    dem, x, y, mask, mask_boundary, mask_boundary_extent, demMeta, gauge_index_1D = pre.importDEMData_And_BC_DEM(
    ...
    numerical.init__fluidField_tensor_DEM(mask, mask_boundary, mask_boundary_extent, x, y, h, qx, qy, wl, z, device)
    ...
    del mask_boundary, mask_nan
    torch.cuda.empty_cache()
    # umerical.exportField()c

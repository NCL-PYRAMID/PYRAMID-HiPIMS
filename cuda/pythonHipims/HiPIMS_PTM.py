...
def run(paraDict):
    ...
    pollutant.init_pollutionField_tensor(p_mass=0.001, Mg=Mg, Ms=Ms, x=x, y=y, dx=dx, mask=mask, manning=numerical._manning, index=numerical._index) 
    ...
    ani.save("/home/lunet/cvxt2/SWE_TEST/output/pollution.mp4",writer=writer)
...
if __name__ == "__main__":
    paraDict = {
        'deviceID' : 0,
        'outputPath' : '/home/lunet/cvxt2/SWE_TEST/output',
        'gauge_position' : [0,0],
        'dx' : 2.,
        'CFL' : 0.5,
        'secondOrder' : True,
